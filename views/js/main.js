...
/* 
PIZZA SLIDER STARTS HERE, START OPTIMIZATION
*/
...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
   ...
   // determineDx is useless, its functions can be done more effieciently inside later functions
  ...
  //   var oldSize = oldWidth / windowWidth;
    ...
    // sizeSwitcher function can be combined with changePizzaSizes and cut out extra work
  ...
  // TODO - fix this function - its got repeated elements
