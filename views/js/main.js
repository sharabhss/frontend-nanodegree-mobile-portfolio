...
var resizePizzas = function(size) {
  ...
  //Note: used getElementById for optimization
  ...
  // NOTE: Deleted detemineDx function (useless) and combined sizeSwitcher and changePizzaSizes to one function
  ...
  function changePizzaSizes(size) {
    ...
    //Note: Used "getElementByClassName" for optimization
...
// NOTE: moved outside for loop for optimization 
...
function updatePositions() {
  ...
  // NOTE: Moved scrollTop calculation outside for loop as a constant
